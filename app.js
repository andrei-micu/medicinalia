(function () {
    ...
    var app = angular.module("poc", ["ngMockE2E"]);
    ...
    app.run(function ($httpBackend) {
            ...
            $httpBackend.whenJSONP('/plants/id2').respond({
                "name": "Satureja",
                "desciption": "Satureja is a genus of aromatic plants of the family Lamiaceae, related to rosemary and thyme. There are about 30 species called savories, of which summer savory and winter savory are the most important in cultivation.",
                "photo_links": [
